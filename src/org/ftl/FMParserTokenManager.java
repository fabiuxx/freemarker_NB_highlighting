...
public class FMParserTokenManager implements FMParserConstants {
    ...
    /**
     * The noparseTag is set when we enter a block of text that the parser more
     * or less ignores. These are <noparse> and <comment>. This variable tells
     * us what the closing tag should be, and when we hit that, we resume
     * parsing. Note that with this scheme, <comment> and <noparse> tags cannot
     * nest recursively, but it is not clear how important that is.
     */
    String noparseTag;

    /**
     * Keeps track of how deeply nested we have the hash literals. This is
     * necessary since we need to be able to distinguish the } used to close a
        ...
        switch (jjmatchedKind) {
            ...
            case 79:
                ...
                if (parenthesisNesting > 0) {
                    ...
                    SwitchTo(NAMED_PARAMETER_EXPRESSION);
                } else {
                    SwitchTo(FM_EXPRESSION);
                }
                break;
